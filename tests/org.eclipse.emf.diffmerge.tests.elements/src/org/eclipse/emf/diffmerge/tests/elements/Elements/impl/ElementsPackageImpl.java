...
public class ElementsPackageImpl extends EPackageImpl implements ElementsPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getStrictElement_SManyContent(), this.getStrictElement(), null, "sManyContent", null, 1, -1, StrictElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStrictElement_SSingleContent(), this.getStrictElement(), null, "sSingleContent", null, 1, 1, StrictElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStrictElement_SManyRef(), this.getStrictElement(), null, "sManyRef", null, 1, -1, StrictElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStrictElement_SSingleRef(), this.getStrictElement(), null, "sSingleRef", null, 1, 1, StrictElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
