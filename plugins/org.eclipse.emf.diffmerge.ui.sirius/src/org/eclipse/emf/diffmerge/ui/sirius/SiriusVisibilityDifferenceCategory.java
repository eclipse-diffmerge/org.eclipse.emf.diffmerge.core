...
/**
 * A difference category that covers Sirius visibility-related differences.
 * @author Olivier Constant
 */
public class SiriusVisibilityDifferenceCategory extends AbstractDifferenceCategory {
  
  /** The ID of this category */
  public static final String ID = "Sirius.Visibility"; //$NON-NLS-1$
  ...
  public boolean covers(IDifference<?> difference_p, EMFDiffNode node_p) {
    ...
    boolean result =
        feature == NotationPackage.eINSTANCE.getView_Visible() ||
        feature == DiagramPackage.eINSTANCE.getDDiagramElement_Visible() ||
        feature == DiagramPackage.eINSTANCE.getDDiagram_ActivatedFilters() ||
        getDifferenceElement(difference_p) instanceof GraphicalFilter;
    return result;
  }
  ...
  public IDifferenceCategory copy() {
    SiriusVisibilityDifferenceCategory copied = new SiriusVisibilityDifferenceCategory();
