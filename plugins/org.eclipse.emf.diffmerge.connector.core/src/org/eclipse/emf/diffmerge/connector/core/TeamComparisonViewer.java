...
import org.eclipse.emf.diffmerge.connector.Messages;
...
public class TeamComparisonViewer extends Viewer {
   ...
   */
  protected void log(Exception e_p) {
    ILog logger = EMFDiffMergeUIPlugin.getDefault().getLog();
    logger.log(new Status(
        IStatus.ERROR,
        EMFDiffMergeUIPlugin.getDefault().getBundle().getSymbolicName(),
        e_p.getMessage()));
  }
