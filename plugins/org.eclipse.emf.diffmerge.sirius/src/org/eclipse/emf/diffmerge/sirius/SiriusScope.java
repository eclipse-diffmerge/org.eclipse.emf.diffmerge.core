...
public class SiriusScope extends GMFScope {
  ...
  /** @see org.eclipse.emf.diffmerge.sirius.SiriusScope getMainProjectName */
  ...
  public boolean add(EObject source_p, EAttribute attribute_p, Object value_p) {
    ...
    if (value_p instanceof String) {
      if (RichTextAttributeRegistry.INSTANCE.getEAttributes().contains(attribute_p)) {
        String replacedValue = replaceRichtextToHardcodedProject(source_p, (String) value_p);
        return super.add(source_p, attribute_p, replacedValue);
  
      } else if (attribute_p == DiagramPackage.Literals.WORKSPACE_IMAGE__WORKSPACE_PATH) {
        String replacedValue = replaceWorkspaceImageToHardcodedProject(source_p, (String) value_p);
        return super.add(source_p, attribute_p, replacedValue);
      }
    }
  ...
  public boolean remove(EObject source_p, EAttribute attribute_p, Object value_p) {
    ...
    if (value_p instanceof String) {
      if (RichTextAttributeRegistry.INSTANCE.getEAttributes().contains(attribute_p)) {
        String replacedValue = replaceRichtextToHardcodedProject(source_p, (String) value_p);
        return super.remove(source_p, attribute_p, replacedValue);
   ...
   */
  private String replaceRichtextToRelative(EObject source_p, String value_p) {
   ...
   * @return a richtext description containing relative paths on images located in the root project
   */
  private String replaceRichtextToHardcodedProject(EObject source_p, String value_p) {
    String projectName = getMainProjectName(source_p);
    if (projectName == null) {
      return value_p;
    }
   ...
   */
  private String replaceWorkspaceImageToRelative(EObject source_p, String value_p) {
    String projectName = getMainProjectName(source_p);
    if (projectName == null) {
      return value_p;
    }
   ...
   */
  private String replaceWorkspaceImageToHardcodedProject(EObject source_p, String value_p) {
    String projectName = getMainProjectName(source_p);
    if (projectName == null) {
      return value_p;
    }
   ...
   */
  private String getProjectName(EObject source_p) {
