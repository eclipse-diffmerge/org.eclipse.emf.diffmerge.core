...
public interface DiffuidataPackage extends EPackage {
   ...
   * @ordered
   */
	int COMPARISON_SELECTION__SELECTED_MATCHES = ISTRUCTURED_SELECTION_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
	int COMPARISON_SELECTION__SELECTED_MATCH_AND_FEATURE = ISTRUCTURED_SELECTION_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
	int COMPARISON_SELECTION__SELECTED_TREE_PATH = ISTRUCTURED_SELECTION_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
	int COMPARISON_SELECTION__SELECTED_VALUE_PRESENCES = ISTRUCTURED_SELECTION_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
	int COMPARISON_SELECTION_FEATURE_COUNT = ISTRUCTURED_SELECTION_FEATURE_COUNT + 5;
   ...
   */
     ...
     * @generated
     */
    EAttribute COMPARISON_SELECTION__DIFF_NODE = eINSTANCE.getComparisonSelection_DiffNode();
