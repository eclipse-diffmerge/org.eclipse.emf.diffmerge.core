...
public class ValueToDifferenceEntryImpl extends EObjectImpl implements
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffdataPackage.VALUE_TO_DIFFERENCE_ENTRY__VALUE,
							oldValue, value));
			}
		}
		return value;
	 ...
	 * @generated
	 */
	public void setKey(Object key_p) {
		setTypedKey(key_p);
	}
	 ...
	 * @generated
	 */
	public IAttributeValuePresence setValue(IAttributeValuePresence value_p) {
