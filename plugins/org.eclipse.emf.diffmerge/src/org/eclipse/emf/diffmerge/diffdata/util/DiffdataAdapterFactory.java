...
public class DiffdataAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiffdataSwitch<Adapter> modelSwitch = new DiffdataSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEAttributeValuePresence(
				EAttributeValuePresence object) {
			return createEAttributeValuePresenceAdapter();
		}

		@Override
		public Adapter caseEReferenceValuePresence(
				EReferenceValuePresence object) {
			return createEReferenceValuePresenceAdapter();
		}

		@Override
		public Adapter caseElementToMatchEntry(Map.Entry<EObject, IMatch> object) {
		...
		@Override
		public Adapter caseIAttributeValuePresence(
				IAttributeValuePresence object) {
			return createIAttributeValuePresenceAdapter();
		}

		@Override
		public Adapter caseIReferenceValuePresence(
				IReferenceValuePresence object) {
