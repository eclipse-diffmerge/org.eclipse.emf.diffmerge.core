...
public class MatchToDifferenceEntryImpl extends EObjectImpl implements
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffdataPackage.MATCH_TO_DIFFERENCE_ENTRY__KEY,
							oldKey, key));
			}
		}
		return key;
	...
	public IReferenceValuePresence getTypedValue() {
		if (value != null && ((EObject) value).eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffdataPackage.MATCH_TO_DIFFERENCE_ENTRY__VALUE,
							oldValue, value));
			}
		}
		return value;
	...
	public void setTypedValue(IReferenceValuePresence newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.MATCH_TO_DIFFERENCE_ENTRY__VALUE, oldValue,
					value));
	}
	 ...
	 * @generated
	 */
	public void setKey(IMatch key_p) {
		setTypedKey(key_p);
	}
	 ...
	 * @generated
	 */
	public IReferenceValuePresence setValue(IReferenceValuePresence value_p) {
