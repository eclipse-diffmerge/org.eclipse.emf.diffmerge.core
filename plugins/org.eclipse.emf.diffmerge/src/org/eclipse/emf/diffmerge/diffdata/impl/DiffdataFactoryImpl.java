...
public class DiffdataFactoryImpl extends EFactoryImpl implements
	...
	public static DiffdataFactory init() {
		try {
			DiffdataFactory theDiffdataFactory = (DiffdataFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.eclipse.org/emf/diffmerge/1.0.0/diffdata"); //$NON-NLS-1$ 
	...
	public EObject create(EClass eClass) {
		...
		case DiffdataPackage.ELEMENT_TO_MATCH_ENTRY:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case DiffdataPackage.IMODEL_SCOPE:
			return createIModelScopeFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case DiffdataPackage.IMODEL_SCOPE:
			return convertIModelScopeToString(eDataType, instanceValue);
		case DiffdataPackage.IMATCH_POLICY:
	 ...
	 * @generated
	 */
	public Map.Entry<EObject, IMatch> createElementToMatchEntry() {
	 ...
	 * @generated
	 */
	public String convertIModelScopeToString(EDataType eDataType,
