...
public interface DiffdataPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EMAPPING__COMPARISON = IEDITABLE_MAPPING_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EMAPPING__MODIFIABLE_CONTENTS = IEDITABLE_MAPPING_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EMAPPING__REFERENCE_COMPLETED_MATCHES = IEDITABLE_MAPPING_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EMAPPING__TARGET_COMPLETED_MATCHES = IEDITABLE_MAPPING_FEATURE_COUNT + 3;

	/**
	 * The feature id for the '<em><b>Ancestor Matches</b></em>' map.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EMAPPING__ANCESTOR_MATCHES = IEDITABLE_MAPPING_FEATURE_COUNT + 4;

	/**
	 * The feature id for the '<em><b>Reference Matches</b></em>' map.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EMAPPING__REFERENCE_MATCHES = IEDITABLE_MAPPING_FEATURE_COUNT + 5;

	/**
	 * The feature id for the '<em><b>Target Matches</b></em>' map.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EMAPPING__TARGET_MATCHES = IEDITABLE_MAPPING_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int EMAPPING_FEATURE_COUNT = IEDITABLE_MAPPING_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int EVALUE_PRESENCE__VALUE = EELEMENT_RELATIVE_PRESENCE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EVALUE_PRESENCE__FEATURE = EELEMENT_RELATIVE_PRESENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EVALUE_PRESENCE__ORDER = EELEMENT_RELATIVE_PRESENCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EVALUE_PRESENCE_FEATURE_COUNT = EELEMENT_RELATIVE_PRESENCE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int EATTRIBUTE_VALUE_PRESENCE__VALUE = EVALUE_PRESENCE__VALUE;
	 ...
	 * @ordered
	 */
	int EATTRIBUTE_VALUE_PRESENCE_FEATURE_COUNT = EVALUE_PRESENCE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EREFERENCE_VALUE_PRESENCE__VALUE = EVALUE_PRESENCE__VALUE;
	 ...
	 * @ordered
	 */
	int EREFERENCE_VALUE_PRESENCE_FEATURE_COUNT = EVALUE_PRESENCE_FEATURE_COUNT + 0;

	/**
	 * The meta object id for the '{@link org.eclipse.emf.diffmerge.diffdata.impl.ElementToMatchEntryImpl <em>Element To Match Entry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.emf.diffmerge.diffdata.impl.ElementToMatchEntryImpl
	 * @see org.eclipse.emf.diffmerge.diffdata.impl.DiffdataPackageImpl#getElementToMatchEntry()
	 * @generated
	 */
	int ELEMENT_TO_MATCH_ENTRY = 9;
	 ...
	 * @generated
	 */
	int REFERENCE_TO_MATCH_TO_DIFFERENCE_ENTRY = 12;
	 ...
	 * @generated
	 */
	int MATCH_TO_DIFFERENCE_ENTRY = 13;
	...
	/**
	 * Returns the meta object for the container reference '{@link org.eclipse.emf.diffmerge.diffdata.EMapping#getComparison <em>Comparison</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getEMapping_Comparison();
	...
	/**
	 * Returns the meta object for the map '{@link org.eclipse.emf.diffmerge.diffdata.EMapping#getAncestorMatches <em>Ancestor Matches</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>Ancestor Matches</em>'.
	 * @see org.eclipse.emf.diffmerge.diffdata.EMapping#getAncestorMatches()
	 * @see #getEMapping()
	 * @generated
	 */
	EReference getEMapping_AncestorMatches();

	/**
	 * Returns the meta object for the map '{@link org.eclipse.emf.diffmerge.diffdata.EMapping#getReferenceMatches <em>Reference Matches</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>Reference Matches</em>'.
	 * @see org.eclipse.emf.diffmerge.diffdata.EMapping#getReferenceMatches()
	 * @see #getEMapping()
	 * @generated
	 */
	EReference getEMapping_ReferenceMatches();

	/**
	 * Returns the meta object for the map '{@link org.eclipse.emf.diffmerge.diffdata.EMapping#getTargetMatches <em>Target Matches</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>Target Matches</em>'.
	 * @see org.eclipse.emf.diffmerge.diffdata.EMapping#getTargetMatches()
	 * @see #getEMapping()
	 * @generated
	 */
	EReference getEMapping_TargetMatches();
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.emf.diffmerge.diffdata.EValuePresence#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see org.eclipse.emf.diffmerge.diffdata.EValuePresence#getValue()
	 ...
	 *        valueType="org.eclipse.emf.diffmerge.diffdata.IMatch" valueRequired="true"
	 * @generated
	 */
	 ...
	 * @generated
	 */
	EReference getElementToMatchEntry_Key();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference EMAPPING__COMPARISON = eINSTANCE.getEMapping_Comparison();
		...
		/**
		 * The meta object literal for the '<em><b>Ancestor Matches</b></em>' map feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference EMAPPING__ANCESTOR_MATCHES = eINSTANCE
				.getEMapping_AncestorMatches();

		/**
		 * The meta object literal for the '<em><b>Reference Matches</b></em>' map feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference EMAPPING__REFERENCE_MATCHES = eINSTANCE
				.getEMapping_ReferenceMatches();

		/**
		 * The meta object literal for the '<em><b>Target Matches</b></em>' map feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference EMAPPING__TARGET_MATCHES = eINSTANCE
		 ...
		 * @generated
		 */
		EClass EELEMENT_RELATIVE_PRESENCE = eINSTANCE
				.getEElementRelativePresence();
		 ...
		 * @generated
		 */
		EReference EVALUE_PRESENCE__FEATURE = eINSTANCE
		 ...
		 * @generated
		 */
		EClass EATTRIBUTE_VALUE_PRESENCE = eINSTANCE
				.getEAttributeValuePresence();
		 ...
		 * @generated
		 */
		EClass EREFERENCE_VALUE_PRESENCE = eINSTANCE
				.getEReferenceValuePresence();

		/**
		 * The meta object literal for the '{@link org.eclipse.emf.diffmerge.diffdata.impl.ElementToMatchEntryImpl <em>Element To Match Entry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.emf.diffmerge.diffdata.impl.ElementToMatchEntryImpl
		 * @see org.eclipse.emf.diffmerge.diffdata.impl.DiffdataPackageImpl#getElementToMatchEntry()
		 ...
		 * @generated
		 */
		EReference ELEMENT_TO_MATCH_ENTRY__KEY = eINSTANCE
		 ...
		 * @generated
		 */
		EClass VALUE_TO_DIFFERENCE_ENTRY = eINSTANCE
				.getValueToDifferenceEntry();
		 ...
		 * @generated
		 */
		EClass MATCH_TO_DIFFERENCE_ENTRY = eINSTANCE
				.getMatchToDifferenceEntry();
		 ...
		 * @generated
		 */
		EClass IELEMENT_RELATIVE_PRESENCE = eINSTANCE
				.getIElementRelativePresence();
		 ...
		 * @generated
		 */
		EClass IATTRIBUTE_VALUE_PRESENCE = eINSTANCE
				.getIAttributeValuePresence();
		 ...
		 * @generated
		 */
		EClass IREFERENCE_VALUE_PRESENCE = eINSTANCE
				.getIReferenceValuePresence();
		 ...
		 * @generated
		 */
		EDataType IMODEL_SCOPE = eINSTANCE.getIModelScope();
