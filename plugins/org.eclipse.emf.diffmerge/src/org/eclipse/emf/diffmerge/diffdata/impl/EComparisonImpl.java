...
public class EComparisonImpl extends EObjectImpl implements EComparison {
	...
	public void setAncestorScope(IFeaturedModelScope newAncestorScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__ANCESTOR_SCOPE,
					oldAncestorScope, ancestorScope));
	}
	...
	public void setReferenceScope(IFeaturedModelScope newReferenceScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__REFERENCE_SCOPE,
					oldReferenceScope, referenceScope));
	}
	...
	public void setLastMatchPolicy(IMatchPolicy newLastMatchPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__LAST_MATCH_POLICY,
					oldLastMatchPolicy, lastMatchPolicy));
	}
	...
	public void setLastDiffPolicy(IDiffPolicy newLastDiffPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__LAST_DIFF_POLICY,
					oldLastDiffPolicy, lastDiffPolicy));
	}
	...
	public void setLastMergePolicy(IMergePolicy newLastMergePolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__LAST_MERGE_POLICY,
					oldLastMergePolicy, lastMergePolicy));
	}
	...
	public NotificationChain basicSetMapping(EMapping newMapping,
			NotificationChain msgs_p) {
    NotificationChain msgs = msgs_p;
		EMapping oldMapping = mapping;
		mapping = newMapping;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, DiffdataPackage.ECOMPARISON__MAPPING,
		...
		if (newMapping != mapping) {
			...
			if (mapping != null)
				msgs = ((InternalEObject) mapping).eInverseRemove(this,
						DiffdataPackage.EMAPPING__COMPARISON, EMapping.class,
						msgs);
			if (newMapping != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiffdataPackage.ECOMPARISON__MAPPING, newMapping,
					newMapping));
	}
			...
			if (mapping != null)
				msgs = ((InternalEObject) mapping).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- DiffdataPackage.ECOMPARISON__MAPPING, null,
						msgs);
			return basicSetMapping((EMapping) otherEnd, msgs);
		}
	 ...
	 * @generated NOT
	 */
	public IStatus compute(IMatchPolicy matchPolicy_p,
			IDiffPolicy diffPolicy_p, IMergePolicy mergePolicy_p,
		...
		// Behavior
		IStatus result = computeMatch(getLastMatchPolicy(),
		...
		return new AbstractTreeIterator<IMatch>(this, false) {
			...
			protected Iterator<? extends IMatch> getChildren(Object object_p) {
				...
				if (object_p instanceof IComparison)
					result = ((IComparison) object_p).getContents(role_p)
							.iterator();
				else
					result = getContentsOf((IMatch) object_p, role_p)
							.iterator();
				return result;
			}
		};
	...
	protected IExpensiveOperation getMatchOperation(IMatchPolicy policy_p) {
		return new MatchOperation(this, policy_p);
	}
	...
	/**
	 * @see org.eclipse.emf.diffmerge.api.IComparison#isCompleteFor(org.eclipse.emf.diffmerge.api.Role)
	 * @generated NOT
	 */
	public boolean isCompleteFor(Role role_p) {
		return getMapping().isCompleteFor(getScope(role_p), role_p);
	}
	...
	public Collection<IDifference> merge(
			Collection<? extends IDifference> differences_p,
