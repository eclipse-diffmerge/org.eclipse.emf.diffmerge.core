 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.EMapping#getModifiableContents <em>Modifiable Contents</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.EMapping#getReferenceCompletedMatches <em>Reference Completed Matches</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.EMapping#getTargetCompletedMatches <em>Target Completed Matches</em>}</li>
 * </ul>
 *
 * @see org.eclipse.emf.diffmerge.generic.diffdata.DiffdataPackage#getEMapping()
 * @model superTypes="org.eclipse.emf.diffmerge.generic.diffdata.EIdentified org.eclipse.emf.diffmerge.generic.diffdata.IEditableMapping"
 * @generated
 */
public interface EMapping extends EIdentified, Editable {
   ...
   * The list contents are of type {@link org.eclipse.emf.diffmerge.generic.diffdata.EMatch}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.emf.diffmerge.generic.diffdata.DiffdataPackage#getEMapping_ModifiableContents()
   ...
   * @see org.eclipse.emf.diffmerge.generic.diffdata.DiffdataPackage#getEMapping_ReferenceCompletedMatches()
   * @model type="org.eclipse.emf.diffmerge.generic.diffdata.IMatch" resolveProxies="false"
   * @generated
   */
   ...
   * @see org.eclipse.emf.diffmerge.generic.diffdata.DiffdataPackage#getEMapping_TargetCompletedMatches()
   * @model type="org.eclipse.emf.diffmerge.generic.diffdata.IMatch" resolveProxies="false"
   * @generated
   */
