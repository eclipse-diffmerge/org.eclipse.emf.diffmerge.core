...
public class DefaultMergePolicy implements IMergePolicy {
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#bindPresenceToOwnership(org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#copyExtrinsicIDs(org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope, org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#copyFeature(org.eclipse.emf.ecore.EStructuralFeature, org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#copyOutOfScopeCrossReferences(org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope, org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#getAdditionGroup(EObject, IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#getDeletionGroup(EObject, IFeaturedModelScope)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#getDesiredValuePosition(org.eclipse.emf.diffmerge.generic.api.IComparison, org.eclipse.emf.diffmerge.generic.api.Role, org.eclipse.emf.diffmerge.generic.api.IMatch, org.eclipse.emf.ecore.EReference, org.eclipse.emf.ecore.EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#isMandatoryForAddition(org.eclipse.emf.ecore.EReference)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#isMandatoryForDeletion(org.eclipse.emf.ecore.EReference)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMergePolicy#setIntrinsicID(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope, org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope)
   */
