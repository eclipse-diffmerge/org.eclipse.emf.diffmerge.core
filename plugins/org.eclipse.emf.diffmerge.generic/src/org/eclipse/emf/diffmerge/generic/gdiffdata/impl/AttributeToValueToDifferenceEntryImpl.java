 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.gdiffdata.impl.AttributeToValueToDifferenceEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.gdiffdata.impl.AttributeToValueToDifferenceEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeToValueToDifferenceEntryImpl extends EObjectImpl
  ...
  protected EClass eStaticClass() {
    return GdiffdataPackage.Literals.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY;
  }
      ...
      if (key != oldKey) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              GdiffdataPackage.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY__KEY,
              oldKey, key));
      }
    }
    return key;
  ...
  public void setTypedKey(EAttribute newKey) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          GdiffdataPackage.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY__KEY, oldKey,
          key));
  }
  ...
  public EMap<Object, IAttributeValuePresence> getTypedValue() {
    if (value == null) {
      value = new EcoreEMap<Object, IAttributeValuePresence>(
          GdiffdataPackage.Literals.VALUE_TO_DIFFERENCE_ENTRY,
          ValueToDifferenceEntryImpl.class, this,
          GdiffdataPackage.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY__VALUE);
    }
    return value;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd,
    ...
    switch (featureID) {
    case GdiffdataPackage.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY__VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case GdiffdataPackage.ATTRIBUTE_TO_VALUE_TO_DIFFERENCE_ENTRY__KEY:
      if (resolve)
        return getTypedKey();
