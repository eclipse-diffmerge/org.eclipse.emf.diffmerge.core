...
public abstract class AbstractModelScope implements IFeaturedModelScope {
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#covers(EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope#get(org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EReference)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope#get(org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EAttribute)
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#getAllContents()
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#getAllContents(org.eclipse.emf.ecore.EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#getAllContentsAsSet()
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope#getContainment(org.eclipse.emf.ecore.EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#getContents(org.eclipse.emf.ecore.EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#getOriginator()
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IFeaturedModelScope#isContainment(org.eclipse.emf.ecore.EReference)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope#size()
   */
  public int size() {
    int result = 0;
    Iterator<EObject> it = getAllContents();
