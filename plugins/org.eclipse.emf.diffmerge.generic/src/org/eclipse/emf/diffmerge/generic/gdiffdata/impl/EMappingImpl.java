...
public class EMappingImpl extends EIdentifiedImpl implements EMapping {
  ...
  public EList<EMatch> getModifiableContents() {
    if (modifiableContents == null) {
      modifiableContents = new EObjectContainmentEList<EMatch>(EMatch.class,
          this, GdiffdataPackage.EMAPPING__MODIFIABLE_CONTENTS);
    }
  ...
  public IMatch getMatchFor(EObject element_p, Role role_p) {
    ...
    if (role_p != null) {
      ...
      switch (role_p) {
      case ANCESTOR:
        matchReference = GdiffdataPackage.eINSTANCE.getEMatch_Ancestor();
        break;
      case REFERENCE:
        matchReference = GdiffdataPackage.eINSTANCE.getEMatch_Reference();
        break;
      default:
        matchReference = GdiffdataPackage.eINSTANCE.getEMatch_Target();
      }
      if (element_p != null) {
  ...
  protected static class MatchCrossReferenceAdapter
    ...
    protected boolean isIncluded(EReference reference_p) {
      return reference_p == GdiffdataPackage.eINSTANCE.getEMatch_Ancestor()
          || reference_p == GdiffdataPackage.eINSTANCE.getEMatch_Reference()
          || reference_p == GdiffdataPackage.eINSTANCE.getEMatch_Target();
    }
  }
