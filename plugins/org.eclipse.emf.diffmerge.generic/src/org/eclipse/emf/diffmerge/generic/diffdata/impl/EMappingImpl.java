 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.impl.EMappingImpl#getModifiableContents <em>Modifiable Contents</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.impl.EMappingImpl#getReferenceCompletedMatches <em>Reference Completed Matches</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.generic.diffdata.impl.EMappingImpl#getTargetCompletedMatches <em>Target Completed Matches</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EMappingImpl extends EIdentifiedImpl implements EMapping {
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#covers(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping.Editable#crossReference(org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.diffdata.EMapping#getComparison()
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#getCrossReferences(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#getMatchFor(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#isCompleteFor(org.eclipse.emf.diffmerge.generic.api.scopes.IModelScope, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping.Editable#map(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping.Editable#mapIncrementally(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role, org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#maps(org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EObject)
   * @generated NOT
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#maps(org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EObject)
   * @generated NOT
   */
  public boolean maps(EObject target_p, EObject reference_p,
      EObject ancestor_p) {
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.IMapping#maps(org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role, org.eclipse.emf.ecore.EObject, org.eclipse.emf.diffmerge.generic.api.Role)
   * @generated NOT
   */
