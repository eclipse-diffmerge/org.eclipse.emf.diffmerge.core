...
implements IEditableModelScope {
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#add(EObject, EAttribute, Object)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#add(EObject, EReference, EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#isReadOnly()
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#move(org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature, int, int)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#remove(EObject)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#remove(EObject, EAttribute, Object)
   */
  ...
  /**
   * @see org.eclipse.emf.diffmerge.generic.api.scopes.IEditableModelScope#remove(EObject, EReference, EObject)
   */
