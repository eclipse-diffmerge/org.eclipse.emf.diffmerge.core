 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.diffmerge.pojo.pojodiffdata.impl.ElementToMatchEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.diffmerge.pojo.pojodiffdata.impl.ElementToMatchEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementToMatchEntryImpl extends EObjectImpl
  ...
  protected EClass eStaticClass() {
    return PojodiffdataPackage.Literals.ELEMENT_TO_MATCH_ENTRY;
  }
  ...
  public void setTypedKey(Object newKey) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          PojodiffdataPackage.ELEMENT_TO_MATCH_ENTRY__KEY, oldKey, key));
  }
      ...
      if (value != oldValue) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              PojodiffdataPackage.ELEMENT_TO_MATCH_ENTRY__VALUE, oldValue,
              value));
      }
    }
    return value;
  ...
  public void setTypedValue(EMatch newValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          PojodiffdataPackage.ELEMENT_TO_MATCH_ENTRY__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case PojodiffdataPackage.ELEMENT_TO_MATCH_ENTRY__KEY:
      return getTypedKey();
